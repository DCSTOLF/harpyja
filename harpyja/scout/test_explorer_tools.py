...
def test_build_explorer_tools_returns_exactly_three_navigation_tools(tmp_path):
    tools = _tools(tmp_path)
    # EXACTLY the three navigation tools — no terminal submit action, nothing else.
    assert set(tools) == {"grep", "glob", "read_span"}
